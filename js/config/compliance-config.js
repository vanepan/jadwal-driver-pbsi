...
// change; this release only surfaces the STNK/tax values.
export const COMPLIANCE_TYPES = Object.freeze(['annual_tax', 'five_year_tax', 'other']);
...
export function complianceTypeInfo(key) {
  return COMPLIANCE_TYPE_REGISTRY.find(t => t.key === key) || COMPLIANCE_TYPE_REGISTRY[2];
}
